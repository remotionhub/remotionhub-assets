...
const METRICS = [
  { label: "营收",     unit: "万元", max: 1000, satisfactory: 700, target: 850, actual: 920, color: "#3b82f6" },
  { label: "用户成长", unit: "%",   max: 50,   satisfactory: 30,  target: 38,  actual: 34,  color: "#10b981" },
  { label: "客户满意", unit: "分",  max: 100,  satisfactory: 75,  target: 85,  actual: 88,  color: "#8b5cf6" },
  { label: "转换率",   unit: "%",   max: 15,   satisfactory: 8,   target: 11,  actual: 9.5, color: "#f59e0b" },
...
export const DatavizBullet: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { color: "#374151", label: "最大范围" },
          { color: "#6b7280", label: "满意范围" },
          { color: "#ffffff", label: "目标线" },
        ].map((item) => (
          <div
            key={item.label}
          ...
          >
            <div
              style={{
                width: item.label === "目标线" ? 3 : 20,
                height: item.label === "目标线" ? 20 : 12,
                background: item.color,
                borderRadius: item.label === "目标线" ? 2 : 3,
              }}
            />
...
export const datavizBulletDefaultProps = {}
