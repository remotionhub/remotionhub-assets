...
export interface SubtitleSlideItem {
  text: string
  start: number
  end: number
  color: string
...
export interface SubtitleSlideProps {
  subtitles?: SubtitleSlideItem[]
  fontSize?: number
...
export const subtitleSlideDefaultProps: SubtitleSlideProps = {
  fontSize: 48,
  springDamping: 20,
  springStiffness: 120,
  bottomOffset: 110,
  ...
  subtitles: [
    {
      text: '大家好，今天来介绍 Remotion 框架',
      start: 10,
      end: 60,
      color: '#60a5fa',
    },
    {
      text: '它让你用 React 写出动态视频',
      start: 70,
      end: 120,
      color: '#34d399',
    },
    {
      text: '支持 TypeScript，开发体验极佳',
      start: 130,
      end: 180,
      color: '#f59e0b',
    },
