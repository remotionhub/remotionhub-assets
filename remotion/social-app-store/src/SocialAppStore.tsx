...
const RATING = "4.8";
const RATING_COUNT = "12.3k 评分";
const CATEGORY_RANK = "#1 生产力";
const DESCRIPTION =
  "SuperApp 是最强大的生产力工具，帮您整合所有工作流程。支持 iOS 17+ 及 iPadOS。";
const VERSION = "3.2.1";
const SIZE = "142 MB";
...
export const SocialAppStore: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card: slide up + fade, frames 0_20
  ...
  // App icon: scale bounce, frames 10_28
  ...
  // Name + rating: slide from top, frames 18_32
  ...
  // GET button: scale pop, frames 28_40
  ...
  // Screenshots: slide in from right one by one, frames 35_70
  ...
  // Description: fade in, frames 55_72
  const descOpacity = interpolate(frame, [55, 72], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Rating bars: fill left to right, frames 65_95
...
export const socialAppStoreDefaultProps = {}
