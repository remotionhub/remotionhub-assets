...
export const BUG-FIX-LOOP-209-DURATION-FRAMES = 240;

const ISSUES = [
  { problem: "有 Bug", solution: "请修复", color: "#EF4444", solutionColor: "#10B981" },
  { problem: "太丑", solution: "请调整设计", color: "#EF4444", solutionColor: "#10B981" },
  { problem: "缺字", solution: "补文字", color: "#EF4444", solutionColor: "#10B981" },
  { problem: "寄信失败", solution: "确认寄信功能", color: "#EF4444", solutionColor: "#10B981" },
];

export const Scene209-BugFixLoop: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 72, fontWeight: 800, color: "#FFFFFF", textAlign: "center", marginBottom: 12, lineHeight: 1.4 }}>
        反复<span style={{ color: "#F59E0B" }}>修正</span>直到完美
      </div>
