...
export const SERVICE-FIRST-DURATION-FRAMES = 450;

export const Scene169-ServiceFirst: React.FC = () => {
    ...
    >
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", opacity: phaseAOpacity }}>
        <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 60, fontWeight: 700, color: "#FFFFFF", textAlign: "center" }}>
          先做<span style={{ color: "#4DA3FF" }}>服务</span>，再做<span style={{ color: "#10B981" }}>产品</span>
        </div>
        ...
        <svg width={1700} height={500} viewBox="0 0 1100 320">
          <g opacity={phase1Spring} transform={`translate(180, 150) scale(${phase1Spring})`}>
            ...
            <text x={0} y={38} textAnchor="middle" fontSize={20} fill="rgba(77,163,255,0.6)">通电话</text>
            <text x={0} y={80} textAnchor="middle" fontSize={24} fontWeight={700} fill="#4DA3FF">接听 100 通电话</text>
          ...
          <g opacity={phase2Spring} transform={`translate(550, 150) scale(${phase2Spring})`}>
            ...
            <g opacity={insight1}><text x={0} y={-25} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.5)">• 客户常见问题</text></g>
            <g opacity={insight2}><text x={0} y={5} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.5)">• 服务流程全貌</text></g>
            <g opacity={insight3}><text x={0} y={35} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.5)">• 真正的痛点</text></g>
            <text x={0} y={80} textAnchor="middle" fontSize={24} fontWeight={700} fill="#F59E0B">累积经验洞察</text>
          ...
          <g opacity={phase3Spring} transform={`translate(920, 150) scale(${phase3Spring})`}>
            ...
            <text x={0} y={-15} textAnchor="middle" fontSize={26} fontWeight={700} fill="#10B981">针对性</text>
            <text x={0} y={12} textAnchor="middle" fontSize={20} fill="rgba(16,185,129,0.6)">客服机器人</text>
            <g opacity={checkSpring}>
              ...
              <text x={30} y={55} textAnchor="start" fontSize={20} fontWeight={600} fill="#10B981">能解决问题</text>
            </g>
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", opacity: phaseBOpacity }}>
        ...
        <svg width={1700} height={520} viewBox="0 0 1100 340">
          <g opacity={wrongSpring} transform={`translate(280, 160) scale(${wrongSpring})`}>
            ...
            <text x={0} y={-20} textAnchor="middle" fontSize={30} fontWeight={700} fill="#EF4444">通用型客服机器人</text>
            ...
            <text x={0} y={90} textAnchor="middle" fontSize={22} fontWeight={600} fill="rgba(239,68,68,0.6)">没有经验就直接做</text>
          </g>
          ...
          <g opacity={gap1} transform={`translate(820, 160)`}>
            ...
            <text x={0} y={-80} textAnchor="middle" fontSize={30} fontWeight={700} fill="rgba(239,68,68,0.7)">什么都缺了一点</text>
            <g opacity={gap1}><rect x={-155} y={-25} width={145} height={36} rx={10} fill="rgba(239,68,68,0.08)" /><text x={-82} y={0} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.45)">回答不精准</text></g>
            <g opacity={gap2}><rect x={10} y={-25} width={165} height={36} rx={10} fill="rgba(239,68,68,0.08)" /><text x={92} y={0} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.45)">流程不符合实际</text></g>
            <g opacity={gap3}><rect x={-100} y={30} width={200} height={36} rx={10} fill="rgba(239,68,68,0.08)" /><text x={0} y={55} textAnchor="middle" fontSize={20} fill="rgba(255,255,255,0.45)">不能真正解决问题</text></g>
          </g>
        </svg>
      </AbsoluteFill>
    </AbsoluteFill>
