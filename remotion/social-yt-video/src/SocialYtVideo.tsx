...
const VIDEO_TITLE = "用 Remotion 制作专业视频动画\n完整教学从入门到进阶";
const CHANNEL_NAME = "Remotion 中文频道";
const VIEWS_TARGET = 12000;
const DURATION_LABEL = "10:42";

export const SocialYtVideo: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card scale + fade: frames 0_15
  ...
  // Thumbnail fade: frames 5_20
  const thumbOpacity = interpolate(frame, [5, 20], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Play button bounce: frames 18_32
  ...
  // Duration badge fade: frames 25_35
  const durationOpacity = interpolate(frame, [25, 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Title slide up: frames 28_42
  ...
  // Channel + metadata fade: frames 38_55
  const metaOpacity = interpolate(frame, [38, 55], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // View count up: frames 45_80
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {formatViews(currentViews)} 次观看 · 3 天前
            </div>
          </div>
...
export const socialYtVideoDefaultProps = {}
