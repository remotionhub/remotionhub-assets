...
const TESTIMONIALS = [
  {
    ...
    role: "前端工程师",
    stars: 5,
    text: "用 Remotion 做动画比 After Effects 快 5 倍！强烈推荐。",
    color: "#3b82f6",
  },
  {
    name: "林美华",
...
export const SocialTestimonialWall: React.FC = () => {
...
export const socialTestimonialWallDefaultProps = {}
