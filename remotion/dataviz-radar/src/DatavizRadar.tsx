...
const AXES = ["技术", "沟通", "创意", "运行", "协作", "领导"];
const SERIES_A = { name: "候选人 A", values: [85, 72, 90, 78, 88, 65], color: "#3b82f6" };
const SERIES_B = { name: "候选人 B", values: [70, 88, 75, 92, 80, 85], color: "#f59e0b" };
...
export const DatavizRadar: React.FC = () => {
...
export const datavizRadarDefaultProps = {}
