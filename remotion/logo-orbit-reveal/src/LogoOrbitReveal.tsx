...
export const LogoOrbitReveal: React.FC = () => {
  ...
  // 中央图标 scale 0→1（frame 0_35），spring
  ...
  // 轨道半径：frame 0_50 时 100px，frame 50_75 时从 100→0
  ...
  // 圆点 opacity：frame 60_75 从 1→0
  const dotOpacity = interpolate(frame, [60, 75], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // 品牌名「Vertex」spring 入场（frame 70_100）
...
export const logoOrbitRevealDefaultProps = {}
