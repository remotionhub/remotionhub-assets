...
export const MANUAL-FIRST-DURATION-FRAMES = 360;

const PHASES = [
  { label: "手动处理", en: "Manual Work", sub: "先解决问题", color: "#4DA3FF", icon: "✋" },
  { label: "赚到钱", en: "First Revenue", sub: "验证市场", color: "#F59E0B", icon: "💰" },
  { label: "自动化", en: "Automate", sub: "扩大规模", color: "#10B981", icon: "⚙️" },
];

export const Scene170-ManualFirst: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        不要担心<span style={{ color: "#EF4444" }}>手动</span>，先解决问题赚到钱，再<span style={{ color: "#10B981" }}>自动化</span>
      </div>
