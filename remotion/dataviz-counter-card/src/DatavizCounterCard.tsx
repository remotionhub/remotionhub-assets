...
const CARDS = [
  { label: "总用户数", value: 128450, unit: "人", trend: "+12.5%", color: "#3b82f6" },
  { label: "月收益", value: 892000, unit: "元", trend: "+8.3%", color: "#10b981" },
  { label: "转换率", value: 3.7, unit: "%", trend: "+0.4%", color: "#8b5cf6", isDecimal: true },
];
...
export const DatavizCounterCard: React.FC = () => {
...
export const datavizCounterCardDefaultProps = {}
