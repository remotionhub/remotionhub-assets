...
const DISPLAY_NAME = "工程师 Kai";
const HANDLE = "@kai-engineer";
const QUOTE = "写程序不是为了让电脑\n理解，而是为了让人\n能够阅读。";
const LIKES = 2400;
const RETWEETS = 891;
const VIEWS = 48000;
...
export const SocialTwitterQuote: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card scale + fade in: frames 0_20
  ...
  // Avatar + name slide from top: frames 10_25
  ...
  // Quote lines staggered fade in: frames 20_50
  ...
  // Timestamp fade in: frames 60_75
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {[
            { icon: "↺", value: currentRetweets, label: "转推" },
            { icon: "♡", value: currentLikes, label: "喜欢" },
            { icon: "👁", value: currentViews, label: "浏览" },
...
export const socialTwitterQuoteDefaultProps = {}
