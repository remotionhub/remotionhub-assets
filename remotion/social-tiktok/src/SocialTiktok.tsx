...
const DISPLAY_NAME = "Remotion 创作者";
const HANDLE = "@remotion-creator";
const DESCRIPTION = "这支视频展示了 Remotion 动画的可能性 🎬 #remotion #创作者 #动画";
const MUSIC_TEXT = "原创音乐 - 创作者名称";
...
export const SocialTiktok: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card scale + fade: frames 0_18
  ...
  // Thumbnail fade: frames 8_22
  const thumbOpacity = interpolate(frame, [8, 22], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Avatar + name slide from top-right: frames 18_32
  ...
  // Follow button pop: frames 28_40
  ...
  // Description line-by-line fade: frames 35_60
  ...
  // Stats count up staggered: frames 55_90
...
export const socialTiktokDefaultProps = {}
