...
export const LogoEmblem: React.FC = () => {
  ...
  // frame 0_35：外圆边框描绘（strokeDashoffset）
  ...
  // frame 40_70：8 个装饰圆点依序 scale 0→1
  ...
  // frame 60_85：中央星形 scale 0→1（5角星）
  ...
  // 5角星的 polygon points（中心在原点，外半径 40，内半径 16）
...
export const logoEmblemDefaultProps = {}
