...
const TOOLS = [
  { num: 1, name: "Banana 2", desc: "图片生成", color: "#00D4AA", delay: 30 },
  { num: 2, name: "Grok", desc: "图生视频", color: "#FFB547", delay: 75 },
  { num: 3, name: "Suno", desc: "生成音乐", color: "#2ECC71", delay: 120 },
  { num: 4, name: "Blender", desc: "视频去背", color: "#9B59B6", delay: 165 },
];

export const Scene35-FourToolsReveal: React.FC = () => {
