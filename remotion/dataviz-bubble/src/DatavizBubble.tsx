...
const BUBBLES = [
  ...
  { x: 65, y: 72, size: 32, label: "云端",   color: "#3b82f6", group: "科技" },
  { x: 80, y: 65, size: 28, label: "资安",   color: "#3b82f6", group: "科技" },
  { x: 55, y: 80, size: 18, label: "AR/VR",  color: "#3b82f6", group: "科技" },
  // group B - 消费
  { x: 35, y: 45, size: 55, label: "电商",   color: "#10b981", group: "消费" },
  { x: 42, y: 38, size: 38, label: "外送",   color: "#10b981", group: "消费" },
  { x: 28, y: 55, size: 22, label: "订阅",   color: "#10b981", group: "消费" },
  { x: 48, y: 28, size: 15, label: "共享",   color: "#10b981", group: "消费" },
  // group C - 金融
  { x: 20, y: 62, size: 42, label: "支付",     color: "#f59e0b", group: "金融" },
  { x: 30, y: 75, size: 25, label: "加密货币", color: "#f59e0b", group: "金融" },
  { x: 15, y: 48, size: 35, label: "保险",     color: "#f59e0b", group: "金融" },
  { x: 22, y: 35, size: 20, label: "借贷",     color: "#f59e0b", group: "金融" },
];

const LEGEND_GROUPS = [
  { group: "科技", color: "#3b82f6" },
  { group: "消费", color: "#10b981" },
...
export const DatavizBubble: React.FC = () => {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginLeft: 16 }}>
          ...
          <span style={{ color: "#6b7280", fontSize: 20 }}>圆圈大小 = 市占率</span>
        </div>
      </div>
    </AbsoluteFill>
  );
...
export const datavizBubbleDefaultProps = {}
