...
export const ParticleBurstIntro: React.FC = () => {
  ...
  // 粒子爆发：frame 0-40 从中心向外，frame 40-80 向中心汇聚
  ...
  const particles = Array.from({ length: PARTICLE-COUNT }, (_, index) => {
    const angleDeg = (index / PARTICLE-COUNT) * 360;
