...
export const IntroVhsRetro: React.FC = () => {
  ...
  // REC 指示：frame 0_15 fade in，然后每 20 frames 闪烁
  ...
  // 主标题：frame 30_60 fade in（用 spring）
...
export const introVhsRetroDefaultProps = {}
