...
export const NEAR_SELF_FRIENDS_DURATION_FRAMES = 150;
...
export const YtNearSelfFriends: React.FC = () => {
  ...
  const nodeSprings = NEAR_PEOPLE.map((p) =>
    ...
    >
      ...
      <svg width={1050} height={480} viewBox="0 0 700 320">
        <g transform="translate(350, 160)">
          ...
          {NEAR_PEOPLE.filter(p => !p.isCenter).map((p, i) => {
...
export const ytNearSelfFriendsDefaultProps = {}
