...
export const LogoGlowPulse: React.FC = () => {
  ...
  // frame 0_40：菱形 scale(0) spring 弹入
  ...
  // frame 0_40：背景辐射渐层 opacity 0→0.4
  const bgGradientOpacity = interpolate(frame, [0, 40], [0, 0.4], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 35_65：外围光晕 opacity 0→0.7
  ...
  // frame 50_80：「GX」品牌缩写淡入
  const abbrevOpacity = interpolate(frame, [50, 80], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 75_100：品牌名「GlowX」从下方滑入
...
export const logoGlowPulseDefaultProps = {}
