...
export const LogoBadgeUnfold: React.FC = () => {
  ...
  // frame 0_30：整个徽章从 scale(0) spring 弹出
  ...
  // frame 20_70：外圈环形描边（strokeDashoffset 从全长→0）
  ...
  // frame 50_80：徽章内「AC」大字 scale(0)→scale(1)
  ...
  // frame 80_110：品牌全名水平展开（clip-path）
  const clipRight = interpolate(frame, [80, 110], [100, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 100_120：年份淡入 + 字距拉开
...
export const logoBadgeUnfoldDefaultProps = {}
