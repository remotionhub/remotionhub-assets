...
export const GeometricIntro: React.FC = () => {
  ...
  // 图形 1：左上方小方块（40×40px，#3b82f6），从 (-200,-200) → (300, 200)，frame 0-35
  ...
  // 图形 2：右下菱形（50×50px，#8b5cf6，rotate 45deg），从 (2200, 1000) → (1600, 750)，frame 5-40
  ...
  // 图形 3：右上圆形（60px，#f59e0b），从 (2000, -100) → (1500, 200)，frame 10-45
  ...
  // 图形 4：左下小方块（30×30px，#10b981），从 (-100, 1200) → (350, 850)，frame 15-50
  ...
  // 图形 5：左侧菱形（45×45px，#ec4899，rotate 45deg），从 (-200, 500) → (200, 540)，frame 20-55
  ...
  // 图形 6：右侧圆形（35px，#f97316），从 (2100, 500) → (1700, 540)，frame 25-60
  ...
  // 主标题 frame 55-85 缩放进场（scale 0.8→1 + opacity 0→1）
