...
export const LogoRingFocus: React.FC = () => {
  ...
  // frame 0_50：圆圈直径从 600→160，border 从 1px→3px，opacity 0.3→1
  ...
  // frame 65_90：品牌名「FOCUS LABS」淡入
  const brandOpacity = interpolate(frame, [65, 90], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 85_110：标语「See clearly.」淡入
...
export const logoRingFocusDefaultProps = {}
