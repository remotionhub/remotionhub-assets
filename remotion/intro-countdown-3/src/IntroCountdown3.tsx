...
export const IntroCountdown3: React.FC = () => {
  ...
  // 每个数字的退场 opacity：frame 25_30 淡出
  ...
  const color = COUNT_COLORS[currentCount];
...
export const introCountdown3DefaultProps = {}
