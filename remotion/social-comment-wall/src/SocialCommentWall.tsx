...
const COMMENTS = [
  { name: "工程师 Kai", color: "#3b82f6", text: "这个动画超赞！🔥", avatar: "linear-gradient(135deg,#667eea,#764ba2)", liked: false },
  { name: "设计师 Mei", color: "#ec4899", text: "请问用什么工具做的？", avatar: "linear-gradient(135deg,#f093fb,#f5576c)", liked: true },
  { name: "前端新手", color: "#10b981", text: "第一次看到用 React 做视频，太神奇了", avatar: "linear-gradient(135deg,#43e97b,#38f9d7)", liked: false },
  { name: "UI Designer", color: "#f59e0b", text: "颜色搭配很好看 👍", avatar: "linear-gradient(135deg,#fa709a,#fee140)", liked: true },
  { name: "开源爱好者", color: "#8b5cf6", text: "Open source 吗？", avatar: "linear-gradient(135deg,#a18cd1,#fbc2eb)", liked: false },
  { name: "React 粉", color: "#06b6d4", text: "React + 视频 = 完美组合！", avatar: "linear-gradient(135deg,#4facfe,#00f2fe)", liked: true },
  { name: "创作者 Tim", color: "#ef4444", text: "马上去 star 这个 repo ⭐", avatar: "linear-gradient(135deg,#ff9a9e,#fecfef)", liked: false },
  { name: "订阅者", color: "#84cc16", text: "已订阅！期待更多教学视频 🎬", avatar: "linear-gradient(135deg,#a1c4fd,#c2e9fb)", liked: true },
];
...
export const SocialCommentWall: React.FC = () => {
...
export const socialCommentWallDefaultProps = {}
