...
const SEGMENTS = [
  { label: "产品销售", value: 42, color: "#3b82f6" },
  { label: "服务收入", value: 28, color: "#8b5cf6" },
  { label: "广告收益", value: 18, color: "#f59e0b" },
...
export const DatavizPieDonut: React.FC = () => {
...
export const datavizPieDonutDefaultProps = {}
