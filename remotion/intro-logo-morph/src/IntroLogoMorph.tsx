...
export const IntroLogoMorph: React.FC = () => {
  const frame = useCurrentFrame();

  // frame 0_30：圆形从 scale(0) → scale(1) 出现
  const shapeScale = interpolate(frame, [0, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 30_70：border-radius 从 50% → 12px，颜色从白 → #3b82f6
  ...
  // frame 70_100：缩写文字 fade in
  const abbrevOpacity = interpolate(frame, [70, 100], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 100_130：品牌全名从右侧滑入
...
export const introLogoMorphDefaultProps = {}
