...
export const DatavizWaterfall: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { label: "正向项目", color: COLOR_POSITIVE },
          { label: "负向项目", color: COLOR_NEGATIVE },
          { label: "合计", color: COLOR_TOTAL },
        ].map((leg) => (
          <div
            key={leg.label}
...
export const datavizWaterfallDefaultProps = {}
