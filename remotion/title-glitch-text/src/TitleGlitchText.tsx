...
export interface TitleGlitchTextProps {
  text?: string
...
export function TitleGlitchText({
  text = 'GLITCH TEXT',
  ...
  return (
    ...
    >
      <div style={{ position: 'relative', opacity: mainOpacity }}>
        ...
        {/* Main white text */}
        <div style={{ ...baseText, color: textColor, position: 'relative' }}>
          {text}
        </div>
      </div>
    </AbsoluteFill>
...
export const titleGlitchTextDefaultProps: TitleGlitchTextProps = {
  text: 'GLITCH TEXT',
  backgroundColor: '#09090b',
  textColor: '#ffffff',
  redColor: '#ff0033',
