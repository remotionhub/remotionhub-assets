...
export const SocialIgPost: React.FC = () => {
  ...
  // Top bar slide from top: frames 10_25
  ...
  // Image fade in: frames 15_30
  const imageOpacity = interpolate(frame, [15, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Action icons pop in staggered: frames 30_50
  ...
  // Caption fade in: frames 50_70
  const captionOpacity = interpolate(frame, [50, 70], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Comments/timestamp fade in: frames 65_80
...
export const socialIgPostDefaultProps = {}
