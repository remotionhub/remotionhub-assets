...
export const LogoLineDraw: React.FC = () => {
  ...
  // frame 0_60：六边形描边动画，strokeDashoffset 从 780→0
  const strokeOffset = interpolate(frame, [0, 60], [780, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 55_90：fillOpacity 0→0.85（品牌色 #3b82f6）
  const hexFillOpacity = interpolate(frame, [55, 90], [0, 0.85], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 60_90：六边形内部白色三角形 opacity 0→1
  const triangleOpacity = interpolate(frame, [60, 90], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 90_115：品牌名展开，clip-path inset(0 100% 0 0)→inset(0 0% 0 0)
...
export const logoLineDrawDefaultProps = {}
