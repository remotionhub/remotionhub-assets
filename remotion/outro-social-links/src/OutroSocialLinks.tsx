...
const PLATFORM_START = 30; // 平台进场开始 frame
const FADEOUT_START = 150; // 全体 fade out 开始 frame

export const OutroSocialLinks: React.FC = () => {
...
export const outroSocialLinksDefaultProps = {}
