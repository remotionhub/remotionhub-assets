...
const TWEETS = [
  {
    ...
    time: "2h",
    verified: true,
    text: "刚发现 Remotion 可以用 React 写视频，这真的太酷了！整个打开新世界的感觉 🚀",
    replies: 24,
    retweets: 187,
    likes: 1423,
    views: 28400,
  ...
  },
  {
    ...
    time: "6h",
    verified: true,
    text: "本周热门：#Remotion 3.0 正式发布！支持 Lambda 渲染、React 19、以及全新的 CLI 工具。",
    replies: 18,
    retweets: 423,
    likes: 3241,
    views: 89000,
  },
  {
    ...
    time: "8h",
    verified: false,
    text: "推荐给所有创作者：@remotion 让视频制作变得像写程序一样。GitHub 已破 20k ⭐",
    replies: 12,
    retweets: 98,
    likes: 876,
    views: 15600,
...
export const SocialTwitterFeed: React.FC = () => {
...
export const socialTwitterFeedDefaultProps = {}
