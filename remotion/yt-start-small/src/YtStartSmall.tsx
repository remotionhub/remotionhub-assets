...
export const START_SMALL_DURATION_FRAMES = 210;
...
export const YtStartSmall: React.FC = () => {
  ...
  const smallSprings = SMALL_STARTS.map((s) =>
...
export const ytStartSmallDefaultProps = {}
