  ...
  return (
    <svg width={1650} height={300} viewBox="-550 -100 1100 200">
      ...
      >
        ...
        <text x="0" y="22" textAnchor="middle" fontSize="16" fontWeight="500" fontFamily={fonts.main} fill="#FFFFFFcc">「我想做一个...」</text>
      </g>
      ...
      >
        ...
        <text x="0" y="-8" textAnchor="middle" fontSize="22" fontWeight="700" fontFamily={fonts.main} fill={colors.accent}>问 AI</text>
        <text x="0" y="22" textAnchor="middle" fontSize="16" fontWeight="500" fontFamily={fonts.main} fill={colors.dimmed}>「这叫什么游戏？」</text>
      </g>
      ...
      >
        ...
        <text x="0" y="-8" textAnchor="middle" fontSize="22" fontWeight="700" fontFamily={fonts.main} fill={colors.accent}>精确名称</text>
        <text x="0" y="22" textAnchor="middle" fontSize="16" fontWeight="500" fontFamily={fonts.main} fill={colors.dimmed}>节省沟通成本</text>
      </g>
    </svg>
  );
};

export const Scene15-AskAiTip: React.FC = () => {
    ...
    <AbsoluteFill style={{ background: colors.backgroundGradient }}>
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 75, opacity: fadeOut }}>
        ...
        <div style={{
          ...
          先问名称，再给指令 →{" "}
          <span style={{ color: colors.accent, fontWeight: 700 }}>省时省力</span>
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
