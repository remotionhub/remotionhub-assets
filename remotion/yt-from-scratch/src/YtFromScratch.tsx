...
const EmptyFileIcon: React.FC<{ frame: number; fps: number }> = ({ frame, fps }) => {
  ...
  return (
    <svg width={260} height={360} viewBox="0 0 260 360">
      ...
      <text x="130" y="345" textAnchor="middle" fontSize="22" fontWeight="600" fontFamily="'Noto Sans TC', 'Inter', sans-serif" fill="rgba(77,163,255,0.7)" opacity={labelOpacity}>空白文件</text>
    </svg>
  );
};
...
const FullFileIcon: React.FC<{ frame: number; fps: number }> = ({ frame, fps }) => {
  ...
  return (
    <svg width={260} height={360} viewBox="0 0 260 360">
      ...
      <text x="130" y="345" textAnchor="middle" fontSize="22" fontWeight="600" fontFamily="'Noto Sans TC', 'Inter', sans-serif" fill="rgba(52,211,153,0.8)" opacity={labelOpacity}>完整代码</text>
    </svg>
  );
};
...
export const YtFromScratch: React.FC = () => {
...
export const ytFromScratchDefaultProps = {}
