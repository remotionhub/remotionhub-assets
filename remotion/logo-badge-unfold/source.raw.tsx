...
export const LogoBadgeUnfold: React.FC = () => {
  ...
  // frame 0-30：整个徽章从 scale(0) spring 弹出
  ...
  // frame 20-70：外圈环形描边（strokeDashoffset 从全长→0）
  ...
  // frame 50-80：徽章内「AC」大字 scale(0)→scale(1)
  ...
  // frame 80-110：品牌全名水平展开（clip-path）
  const clipRight = interpolate(frame, [80, 110], [100, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 100-120：年份淡入 + 字距拉开
