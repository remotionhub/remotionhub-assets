...
const VIDEO_CARDS: VideoCard[] = [
  {
    title: "Remotion 动画入门完整教学",
    channel: "Remotion 中文社群",
    views: "12,400 次观看",
    duration: "18:32",
  },
  {
    title: "Spring 弹性动画深度解析",
    channel: "Remotion 中文社群",
    views: "8,710 次观看",
    duration: "12:05",
  },
  {
    title: "用 Remotion 制作动态标题",
    channel: "Remotion 中文社群",
    views: "5,280 次观看",
    duration: "9:47",
  },
  {
    title: "Lambda 云端渲染实战指南",
    channel: "Remotion 中文社群",
    views: "3,950 次观看",
    duration: "22:18",
  },
...
export const OutroPlaylist: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // 顶部标题 fade in + translateY（frame 10_35）
...
export const outroPlaylistDefaultProps = {}
