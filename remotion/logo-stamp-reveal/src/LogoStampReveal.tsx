...
export const LogoStampReveal: React.FC = () => {
  ...
  // frame 0_15：印章从上方快速落下（y: -500 → 0）
  const stampY = interpolate(frame, [0, 15], [-500, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 14_18：冲击 scale 1.0→1.03→1.0
  ...
  // frame 12_22：白色光晕 opacity 0→0.6→0
...
export const logoStampRevealDefaultProps = {}
