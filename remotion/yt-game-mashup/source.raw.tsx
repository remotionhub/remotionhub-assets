...
const GAMES = [
  { label: "小朋友上楼梯", subLabel: "往上跳跃", color: "#2ECC71" },
  { label: "派对游戏", subLabel: "多人欢乐", color: colors.warning },
  { label: "玛利欧赛车", subLabel: "道具机制", color: "#FF6B6B" },
];
...
export const Scene23-GameMashup: React.FC = () => {
