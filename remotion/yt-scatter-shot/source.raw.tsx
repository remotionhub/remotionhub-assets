...
export const SCATTER-SHOT-DURATION-FRAMES = 210;
...
export const Scene187-ScatterShot: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 66, fontWeight: 700, color: "#FFFFFF", textAlign: "center", marginBottom: 15 }}>
        <span style={{ color: "#EF4444" }}>乱枪打鸟</span>：受众痛点跟你的不同
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 60 }}>
        ...
        <div style={{ opacity: rightSpring }}>
          <div style={{ fontSize: 26, fontWeight: 700, color: "rgba(239,68,68,0.8)", marginBottom: 20, textAlign: "center" }}>痛点不符 ✗</div>
          <div style={{ opacity: mismatch1, background: "rgba(239,68,68,0.06)", border: "1.5px solid rgba(239,68,68,0.25)", borderRadius: 10, padding: "12px 28px", marginBottom: 12, fontSize: 24, color: "rgba(255,255,255,0.5)" }}>受众的痛点：A</div>
