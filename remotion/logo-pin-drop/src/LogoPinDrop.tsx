...
export const LogoPinDrop: React.FC = () => {
  ...
  // frame 0_20：定位针从 y:-300 落下到 y:0
  const pinY = interpolate(frame, [0, 20], [-300, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: (t) => t * t, // 缓入（加速落下）
  });

  // frame 18_28：落地冲击垂直方向压缩弹跳（scaleY）
  ...
  // frame 20_30：落地阴影圆圈从 scale(0)→scale(1)
  ...
  // frame 30_65：圆形部分从 120→200px（spring）
  ...
  // frame 55_85：圆形内「LC」缩写 scale(0)→(1)
  ...
  // frame 80_105：「LocationCo.」文字从 y:+20→0 淡入
...
export const logoPinDropDefaultProps = {}
