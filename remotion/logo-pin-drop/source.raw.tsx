...
export const LogoPinDrop: React.FC = () => {
  ...
  // frame 18-28：落地冲击垂直方向压缩弹跳（scaleY）
  ...
  // frame 20-30：落地阴影圆圈从 scale(0)→scale(1)
  ...
  // frame 30-65：圆形部分从 120→200px（spring）
  ...
  // frame 55-85：圆形内「LC」缩写 scale(0)→(1)
  ...
  // frame 80-105：「LocationCo.」文字从 y:+20→0 淡入
