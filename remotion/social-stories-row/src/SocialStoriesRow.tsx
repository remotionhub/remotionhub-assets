...
const STORIES = [
  { name: "你的限动", gradient: "linear-gradient(135deg,#667eea,#764ba2)", ring: "add", seen: false },
  ...
  { name: "前端周报", gradient: "linear-gradient(135deg,#a18cd1,#fbc2eb)", ring: "seen", seen: true },
...
export const SocialStoriesRow: React.FC = () => {
...
export const socialStoriesRowDefaultProps = {}
