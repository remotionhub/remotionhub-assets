...
const STAGES = [
  ...
  { label: "点击", value: 28000, color: "#6366f1" },
  { label: "加入购物车", value: 12000, color: "#8b5cf6" },
  { label: "结帐", value: 5500, color: "#a855f7" },
  { label: "完成购买", value: 3200, color: "#c026d3" },
];
...
export const DatavizFunnel: React.FC = () => {
...
export const datavizFunnelDefaultProps = {}
