...
const TAGLINE = "让工作效率提升 10 倍的 AI 工具";
const DESCRIPTION =
  "这是一款革命性的工具，帮助创作者和开发者更快地完成工作。整合 AI 技术，自动化繁琐任务，让你专注于真正重要的事。";
const TAGS = ["#生产力", "#AI", "#设计工具"];
const VOTES_TARGET = 856;
const COMMENTS = 124;
const RANK = "#1 今日产品";
const PH_ORANGE = "#ff6154";

export const SocialProducthunt: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card: scale 0.9→1 + fade, frames 0_20
  ...
  // Logo: scale pop 0→1.1→1, frames 10_28
  ...
  // Product name + tagline: slide from right, frames 18_35
  ...
  // Tags: pop in stagger, frames 30_55
  ...
  // Description: fade in, frames 40_60
  const descOpacity = interpolate(frame, [40, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Vote count: count up 0→856, frames 55_90
  ...
  // CTA button: scale in + glow, frames 70_85
...
export const socialProducthuntDefaultProps = {}
