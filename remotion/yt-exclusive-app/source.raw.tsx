...
export const EXCLUSIVE-APP-DURATION-FRAMES = 210;

const APPS = [
  { title: "健身追踪", subtitle: "Fitness Tracker", icon: "💪", color: "#10B981", delay: 30 },
  { title: "饮食管理", subtitle: "Diet Manager", icon: "🥗", color: "#4DA3FF", delay: 55 },
  { title: "进度记录", subtitle: "Progress Log", icon: "📈", color: "#F59E0B", delay: 80 },
];

export const Scene180-ExclusiveApp: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 72, fontWeight: 700, color: "#FFFFFF", textAlign: "center", marginBottom: 15 }}>
        直接为他们做一个<span style={{ color: "#10B981" }}>专属 APP</span>
      </div>
      ...
      <div style={{ display: "flex", gap: 48 }}>
        {APPS.map((app, i) => (
          ...
          >
            ...
            <div style={{ fontSize: 18, color: "rgba(255,255,255,0.4)", textAlign: "center" }}>专属功能</div>
          </div>
        ))}
      </div>
    </AbsoluteFill>
