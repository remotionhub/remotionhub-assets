...
export const INSIDE-THE-PROBLEM-DURATION-FRAMES = 210;

export const Scene217-InsideTheProblem: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 63, fontWeight: 800, color: "#FFFFFF", textAlign: "center", marginBottom: 9, lineHeight: 1.4 }}>
        要在<span style={{ color: "#10B981" }}>问题的圈子</span>里
      </div>
      ...
      <svg width={1575} height={645} viewBox="0 0 1050 430">
        ...
        <g transform="translate(250, 215)">
          <text x={0} y={-190} textAnchor="middle" fontSize={18} fontWeight={700} fill="#EF4444" opacity={circleLeft}>不在圈子里</text>
          ...
          <text x={0} y={-5} textAnchor="middle" fontSize={14} fontWeight={600} fill="#EF4444" opacity={circleLeft * 0.35}>问题圈子</text>
          ...
          <text x={0} y={145} textAnchor="middle" fontSize={16} fontWeight={700} fill="#EF4444" opacity={circleLeft}>很难精准打击痛点</text>
        ...
        <g transform="translate(800, 215)">
          <text x={0} y={-190} textAnchor="middle" fontSize={18} fontWeight={700} fill="#10B981" opacity={circleRight}>在圈子里</text>
          ...
          <text x={0} y={-75} textAnchor="middle" fontSize={14} fontWeight={600} fill="#10B981" opacity={circleRight * 0.5}>问题圈子</text>
          ...
          <text x={0} y={145} textAnchor="middle" fontSize={16} fontWeight={700} fill="#10B981" opacity={circleRight}>精准打击痛点</text>
