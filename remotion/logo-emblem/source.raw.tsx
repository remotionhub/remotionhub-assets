...
export const LogoEmblem: React.FC = () => {
  ...
  // frame 0-35：外圆边框描绘（strokeDashoffset）
  ...
  // frame 40-70：8 个装饰圆点依序 scale 0→1
  ...
  // frame 80-105：「PR」品牌缩写淡入
  const abbrevOpacity = interpolate(frame, [80, 105], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // frame 95-120：底部丝带展开（clip-path）
  ...
  // frame 110-130：顶部「AWARD OF EXCELLENCE」淡入
