...
export const MAGAZINE-STYLE-DURATION-FRAMES = 180;

export const Scene77-MagazineStyle: React.FC = () => {
      ...
      >
        <div style={{ opacity: browserOpacity, transform: `scale(${browserScale})`, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <svg width="1290" height="810" viewBox="0 0 860 540">
            ...
            <text x="80" y="292" fontSize="18" fontFamily={fonts.main} fill="#1A0F00" fontWeight="800" opacity={leftTitleOpacity}>设计的艺术</text>
            ...
            <text x="458" y="210" fontSize="12" fontFamily={fonts.main} fill={warmDeep} fontWeight="700" fontStyle="italic" opacity={rightPullOpacity}>「像翻书一样的浏览体验」</text>
            {[0, 1, 2, 3].map((i) => (
