...
export const CORE-FLOW-DURATION-FRAMES = 210;

const STEPS = [
  { label: "使用者输入", en: "User Input", sub: "填写创业想法", icon: "📝", color: "#4DA3FF", delay: 20 },
  { label: "搜寻数据", en: "Search", sub: "爬取相关资讯", icon: "🔍", color: "#F59E0B", delay: 70 },
  { label: "AI 分析", en: "AI Analysis", sub: "产生可行性报告", icon: "🤖", color: "#10B981", delay: 120 },
];

export const Scene202-CoreFlow: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ opacity: titleSpring, transform: `translateY(${(1 - titleSpring) * 20}px)`, fontSize: 60, fontWeight: 700, color: "#FFFFFF", textAlign: "center", marginBottom: 15 }}>
        核心功能：<span style={{ color: "#4DA3FF" }}>输入</span>→<span style={{ color: "#F59E0B" }}>搜寻</span>→<span style={{ color: "#10B981" }}>AI 分析</span>
      </div>
