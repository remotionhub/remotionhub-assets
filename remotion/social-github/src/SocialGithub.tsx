...
const DESCRIPTION = "一个超棒的开源项目，让开发者更高效地完成工作。欢迎 Star ⭐";
const TOPICS = ["TypeScript", "React", "Animation", "Open Source"];
const STARS = 2400;
const FORKS = 342;
const WATCHERS = 1800;
const LICENSE = "MIT";
const LAST_UPDATE = "3 小时前";
const LANGUAGE = "TypeScript";
const LANG_PERCENT = "94.2%";

export const SocialGithub: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  // Card scale + fade in: frames 0_18
  ...
  // Header (logo + url): fade in, frames 8_22
  const headerOpacity = interpolate(frame, [8, 22], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Repo name: slide from left, frames 18_32
  ...
  // Description: fade in, frames 28_44
  const descOpacity = interpolate(frame, [28, 44], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Topic tags: pop in one by one, frames 38_65 (stagger 5 frames)
  ...
  // Bottom bar: fade in, frames 75_88
...
export const socialGithubDefaultProps = {}
