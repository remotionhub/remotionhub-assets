...
export const SUCCESS-PATH-DURATION-FRAMES = 210;

const STEPS = [
  { label: "先做服务", en: "Service First", color: "#4DA3FF" },
  { label: "创建自动化", en: "Automate", color: "#F59E0B" },
  { label: "产品化", en: "Productize", color: "#10B981" },
];

export const Scene168-SuccessPath: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        这套流程是比较容易<span style={{ color: "#10B981" }}>成功</span>的路
      </div>
      <div
        style={{
