...
const LEFT = {
  ...
  color: "#3b82f6",
  metrics: [
    { label: "总营收", value: 4850000, unit: "元" },
    { label: "新用户", value: 23400, unit: "人" },
    { label: "订单数", value: 18750, unit: "笔" },
    { label: "满意度", value: 88, unit: "%" },
  ],
};
...
const RIGHT = {
  ...
  color: "#8b5cf6",
  metrics: [
    { label: "总营收", value: 6320000, unit: "元" },
    { label: "新用户", value: 31800, unit: "人" },
    { label: "订单数", value: 25400, unit: "笔" },
    { label: "满意度", value: 94, unit: "%" },
  ],
};
...
function formatNumber(value: number, unit: string): string {
  ...
  if (value >= 1000000) return (value / 10000).toFixed(0) + " 万元";
...
export const DatavizComparisonSplit: React.FC = () => {
...
export const datavizComparisonSplitDefaultProps = {}
