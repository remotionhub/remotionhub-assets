...
export const LogoBrandKit: React.FC = () => {
  ...
  // frame 0_30：图标 scale 0→1 spring 弹入
  ...
  // frame 80_115：4 个色票依序 scale 0→1（各差 8 帧）
...
export const logoBrandKitDefaultProps = {}
